...
CI runs those checks plus `npm run audit:dependencies` on every pull request. The publication check also reads
...
[SECURITY.md](SECURITY.md) and never in a public issue.
