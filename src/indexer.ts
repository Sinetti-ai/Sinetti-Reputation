...
/**
 * A misconfiguration, not a transient fault. Retrying cannot resolve it — the
 * chain will keep serving the same answer — so watch mode must exit rather than
 * poll forever behind an ever-growing backoff.
 */
 ...
 *
 * Null is reserved for "this vocabulary has no such field" — V02, where the
